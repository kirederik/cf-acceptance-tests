...
* `use_istio_ingress`: Set to true if running against a "Cloud Foundry for Kubernetes" environment using [cf-k8s-networking](https://github.com/cloudfoundry/cf-k8s-networking) with an Istio Proxy for ingress routing. (default is `false`)
